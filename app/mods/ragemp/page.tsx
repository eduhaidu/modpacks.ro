...
export default function RAGEMPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_#4ca2ff_0%,_#2f7cff_30%,_#3a67db_62%,_#8fb4ef_100%)] text-[#0c1731]">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1240px] flex-col px-6 pb-10 pt-4 md:px-10">
        ...
        <section className="mt-14 flex items-center justify-between gap-4">
          <label className="flex h-12 w-full max-w-[290px] items-center gap-3 rounded-full bg-[#f3efe9] px-4 text-sm text-black/70 shadow-[0_10px_24px_rgba(31,57,123,0.25)] ring-1 ring-black/5">
          ...
          <label className="flex h-11 min-w-[150px] items-center justify-between gap-3 rounded-full bg-[#f3efe9] px-4 text-sm font-medium text-black/75 shadow-[0_10px_24px_rgba(31,57,123,0.25)] ring-1 ring-black/5">
            <select
              value={sortBy}
